...
export const studioRoomProducts: CatalogProduct[] = [
  ...
  {
    id: "studio-room-afterglow",
    type: "studio_room",
    title: "Afterglow",
    detail: "Violet skyline energy with a polished control-room edge for late-night records.",
    price: "$19",
    priceCents: 1900,
    tags: ["After Hours", "Melodic", "Ambition"],
  },
  {
    id: "studio-room-bedroom-diaries",
    type: "studio_room",
    title: "Bedroom Diaries",
    detail: "A private, warm writing room for personal records and first-take honesty.",
    price: "$15",
    priceCents: 1500,
    tags: ["Personal", "Melodic", "Storytelling"],
  },
  {
    id: "studio-room-red-light",
    type: "studio_room",
    title: "Red Light Booth",
    detail: "A close vocal booth built for committed delivery, breath control, and raw takes.",
    price: "$19",
    priceCents: 1900,
    tags: ["Performance", "Street", "Vocals"],
  },
  {
    id: "studio-room-main-room",
    type: "studio_room",
    title: "Main Room",
    detail: "A before-doors-open club environment for testing hook energy, momentum, and replay value.",
    price: "$19",
    priceCents: 1900,
    tags: ["Club", "Energy", "Replay"],
  },
  {
    id: "studio-room-skyline-loft",
    type: "studio_room",
    title: "Skyline Loft",
    detail: "Bright skyline focus for commercial hooks, victory records, and bigger ideas.",
    price: "$29",
    priceCents: 2900,
    tags: ["Commercial", "Victory", "Daylight"],
  },
  {
    id: "studio-room-soft-life",
    type: "studio_room",
    title: "Soft Life Sessions",
    detail: "Ocean light and quiet luxury for melodic writing and effortless records.",
    price: "$24",
    priceCents: 2400,
    tags: ["Melodic", "R&B", "Feel Good"],
  },
  {
    id: "studio-room-desert-sessions",
    type: "studio_room",
    title: "Desert Sessions",
    detail: "Sunset stillness for reflective verses, vivid scenes, and patient storytelling.",
    price: "$19",
    priceCents: 1900,
    tags: ["Storytelling", "Reflective", "Soul"],
  },
  {
    id: "studio-room-rooftop-sessions",
    type: "studio_room",
    title: "Rooftop Sessions",
    detail: "Open-air night energy for ambitious records, bold hooks, and city anthems.",
    price: "$24",
    priceCents: 2400,
    tags: ["Anthem", "Night", "Ambition"],
  },
  {
    id: "studio-room-radio-room",
    type: "studio_room",
    title: "Radio Room",
    detail: "Broadcast-room precision for clear titles, commercial records, and replay-ready hooks.",
    price: "$24",
    priceCents: 2400,
    tags: ["Broadcast", "Commercial", "Replay"],
  },
  {
    id: "studio-room-bando-sessions",
    type: "studio_room",
    title: "Bando Sessions",
    detail: "Stripped-back pressure for survival stories, pain records, and unfiltered bars.",
    price: "$15",
    priceCents: 1500,
    tags: ["Street", "Pain", "Raw"],
  },
];
...
export const bundleProducts: CatalogBundle[] = [
  {
    ...
    type: "bundle",
    title: "Penthouse Sessions Bundle",
    detail: "Three owned assets for commercial writing: the Penthouse room, Gold Executive theme, and Finish Better Hooks pack.",
    price: "$9.99",
    priceCents: 999,
